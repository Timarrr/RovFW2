...
public:
     ...
     * @param init_ms_remaining How much do we need to wait for the thrusters to init? Used for "parallalisation" when the ROV inits other subsystems while thrusters do their thing
     */
